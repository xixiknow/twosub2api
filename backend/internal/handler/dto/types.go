...
type UsageLog struct {
	...
	// UpstreamModel is the actual model used by the upstream provider.
	...
	// InboundEndpoint is the client-facing API endpoint path.
	InboundEndpoint *string `json:"inbound_endpoint,omitempty"`
	// UpstreamEndpoint is the normalized upstream endpoint path.
