...
func (r *stubAccountRepoForHandler) ListWithFilters(context.Context, pagination.PaginationParams, string, string, string, string, int64, bool) ([]service.Account, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
