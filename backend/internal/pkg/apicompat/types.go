...
// derefInt returns the int value from a pointer, defaulting to 0 if nil.
...
type ChatTokenDetails struct {
	CachedTokens             int `json:"cached_tokens,omitempty"`
	CacheCreationInputTokens int `json:"cache_creation_input_tokens,omitempty"` // non-standard: some proxies include this
}

// ChatCompletionTokensDetails provides a breakdown of completion token usage.
