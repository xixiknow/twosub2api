...
const (
	...
	AccountTypeBedrock    = domain.AccountTypeBedrock    // AWS Bedrock 类型账号
)
...
const (
	...
	SettingKeyModelSquareEnabled          = "model_square_enabled"          // 是否向普通用户开放模型广场
	SettingKeyAvailabilityCheckEnabled    = "availability_check_enabled"    // 是否向普通用户开放可用性检测
	...
	// 登录 IP 提醒
	SettingKeyLoginIPAlertEnabled = "login_ip_alert_enabled" // 是否启用登录IP异常提醒
)
