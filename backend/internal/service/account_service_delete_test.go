...
func (s *accountRepoStub) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search string, groupID int64, ungrouped bool) ([]Account, *pagination.PaginationResult, error) {
...
func (s *accountRepoStub) GetGroupIDsByAccountID(ctx context.Context, accountID int64) ([]int64, error) {
	panic("unexpected GetGroupIDsByAccountID call")
}
