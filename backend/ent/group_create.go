...
// SetModelPerRequestPrices sets the "model_per_request_prices" field.
func (u *GroupUpsert) SetModelPerRequestPrices(v map[string]float64) *GroupUpsert {
	u.Set(group.FieldModelPerRequestPrices, v)
	return u
}

// UpdateModelPerRequestPrices sets the "model_per_request_prices" field to the value that was provided on create.
func (u *GroupUpsert) UpdateModelPerRequestPrices() *GroupUpsert {
	u.SetExcluded(group.FieldModelPerRequestPrices)
	return u
}
...
// SetModelPerRequestPrices sets the "model_per_request_prices" field.
func (u *GroupUpsertOne) SetModelPerRequestPrices(v map[string]float64) *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.SetModelPerRequestPrices(v)
	})
}

// UpdateModelPerRequestPrices sets the "model_per_request_prices" field to the value that was provided on create.
func (u *GroupUpsertOne) UpdateModelPerRequestPrices() *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateModelPerRequestPrices()
	})
}
...
// SetModelPerRequestPrices sets the "model_per_request_prices" field.
func (u *GroupUpsertBulk) SetModelPerRequestPrices(v map[string]float64) *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.SetModelPerRequestPrices(v)
	})
}
...
// UpdateModelPerRequestPrices sets the "model_per_request_prices" field to the value that was provided on create.
func (u *GroupUpsertBulk) UpdateModelPerRequestPrices() *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateModelPerRequestPrices()
	})
}
