export default {
  ...
  auth: {
    ...
    referralCodePlaceholder: 'Enter referrer\'s code',
    ...
    passwordResetDisabled: 'Password Reset Not Available',
    passwordResetDisabledHint: 'The password reset feature is not enabled. Please contact the administrator for help.',
    ...
    loginIP: {
      currentIP: 'Current Login IP',
      lastIP: 'Last Login IP',
      firstLogin: 'This is your first login'
    }
  },
  ...
  keys: {
    ...
    selectFallbackGroup: 'Select fallback group (optional)',
    statusLabel: 'Status',
  ...
  profile: {
    ...
    vip: {
      title: 'VIP Status',
      enabledHint: 'VIP pricing rules are active for this account',
      disabledHint: 'Showing level progress only, VIP discount is not enabled',
      currentLevel: 'Current Level',
      multiplier: 'Multiplier',
      progress: 'Progress',
      upgradeProgress: 'Progress to next level',
      rechargeTotal: 'Total Paid',
      spendTotal: 'Total Spend',
      nextLevel: 'Next Level',
      remainingRecharge: 'Remaining Paid',
      remainingSpend: 'Remaining Spend',
      maxLevelReached: 'You have reached the highest VIP level'
    },
  ...
  admin: {
    ...
    users: {
      ...
      concurrencyMin: 'Concurrency must be at least 1',      amountRequired: 'Please enter a valid amount',
      ...
      allTypes: 'All Types',
      typePaymentBalance: 'Balance (Payment)',
    ...
    groups: {
      ...
      rateMultipliers: 'User Rate Multipliers',
      addUserRate: 'Add User Rate Multiplier',
      searchUserPlaceholder: 'Search user email...',
      noRateMultipliers: 'No user rate multipliers set',
      clearAll: 'Clear All',
    ...
    accounts: {
      ...
      types: {
        ...
        antigravityApikey: 'Connect via Base URL + API Key',        upstream: 'Upstream',
      ...
      supportsAllModels: '(supports all models)',      requestModel: 'Request model',
      ...
      fetchUpstreamModelsSuccess: 'Successfully added {count} models',
      fetchUpstreamModelsFailed: 'Failed to fetch upstream models',
      upstreamModelsTotal: 'Fetched {count} models, select providers to add',
      ...
      creating: 'Creating...',
      updating: 'Updating...',
      accountCreated: 'Account created successfully',      accountUpdated: 'Account updated successfully',
      ...
      oauth: {
        ...
        openai: {
          ...
          sessionTokenAuth: 'Manual ST Input',          sessionTokenRawLabel: 'Raw Input',
      ...
      openaiAccount: 'OpenAI Account',      geminiAccount: 'Gemini Account',
      ...
      geminiImageReceived: 'Received test image #{count}',      // Stats Modal
    ...
    paymentOrders: {
      ...
      description: 'View all user payment orders',
      searchPlaceholder: 'Search order number or user ID',
      allStatus: 'All Status',
      pending: 'Pending',
      paid: 'Paid',
      expired: 'Expired',
      ...
      createdAt: 'Created At',
      paidAt: 'Paid At',
      noOrders: 'No payment orders found',
    ...
    settings: {
      ...
      registration: {
        ...
        loginIPAlert: 'Login IP Alert',
        loginIPAlertHint: 'Show current and last login IP in a popup after user login to detect suspicious logins'
      },
      turnstile: {
      ...
      payment: {
        ...
        description: 'Configure payment gateways and recharge options',
        enabled: 'Enable Payment',
        enabledHint: 'Allow users to top up their balance via online payment',
        generalTitle: 'General Settings',
        currency: 'Currency',
        currencyHint: 'The currency used for payment',
        exchangeRate: 'Exchange Rate',
        exchangeRateHint: 'Exchange rate from payment currency to credits (e.g., 1 CNY = 1 credit)',
        presetAmounts: 'Preset Amounts',
        presetAmountsHint: 'Comma-separated preset amount options for quick selection',
        minAmount: 'Minimum Amount',
        minAmountHint: 'Minimum payment amount allowed',
        maxAmount: 'Maximum Amount',
        maxAmountHint: 'Maximum payment amount allowed',
        alipayTitle: 'Alipay',
        alipayMode: 'Alipay Mode',
        alipayModeDisabled: 'Disabled',
        alipayModeRegular: 'Regular (Web Payment)',
        alipayModeF2f: 'Face-to-Face (QR Code)',
        alipayAppId: 'App ID',
        alipayAppIdHint: 'Alipay application App ID',
        alipayPrivateKey: 'Private Key',
        alipayPrivateKeyHint: 'Already configured (leave blank to keep current)',
        alipayPrivateKeyPlaceholder: 'Enter Alipay private key',
        alipayPublicKey: 'Public Key',
        alipayPublicKeyHint: 'Already configured (leave blank to keep current)',
        alipayPublicKeyPlaceholder: 'Enter Alipay public key',
        wechatTitle: 'WeChat Pay',
        wechatEnabled: 'Enable WeChat Pay',
        wechatAppId: 'App ID',
        wechatAppIdHint: 'WeChat Pay App ID',
        wechatMchId: 'Merchant ID',
        wechatMchIdHint: 'WeChat Pay merchant ID',
        wechatApiKey: 'API Key',
        wechatApiKeyHint: 'Already configured (leave blank to keep current)',
        wechatApiKeyPlaceholder: 'Enter WeChat Pay API key',
        epayTitle: 'EasyPay',
        epayEnabled: 'Enable EasyPay',
        epayType: 'Payment Type',
        epayTypeAlipay: 'Alipay',
        epayTypeWechat: 'WeChat',
        epayTypeBoth: 'Both',
        epayTypeHint: 'Select which payment methods to enable for EasyPay',
        epayApiUrl: 'API URL',
        epayApiUrlHint: 'EasyPay gateway API URL',
        epayApiUrlPlaceholder: 'https://pay.example.com',
        epayPid: 'Merchant ID',
        epayPidHint: 'EasyPay merchant PID',
        epayKey: 'Key',
        epayKeyHint: 'Already configured (leave blank to keep current)',
        epayKeyPlaceholder: 'Enter EasyPay key'
      },      customMenu: {
  ...
  modelSquare: {
    title: 'Model Square',
    subtitle: 'Browse and discover available models with pricing information',
  ...
  wallet: {
    title: 'Wallet',
    description: 'Manage your balance and top-up history',
    currentBalance: 'Current Balance',
    concurrency: 'Concurrency',
    requests: 'requests',
    topUp: 'Top Up',
    ...
    creditPreview: 'You will receive {credit} credits',
    paymentMethod: 'Payment Method',
    methodAlipay: 'Alipay',
    methodAlipayF2f: 'Alipay',
    ...
    scanQrCode: 'Scan the QR code to complete payment',
    paymentSuccessTitle: 'Payment Successful',
    paymentSuccessMessage: 'Your balance has been updated',
    redirecting: 'Redirecting to payment page...',
    goToPay: 'Go to Pay',
    waitingPayment: 'Waiting for payment...',
    checking: 'Checking...',
    alreadyPaid: 'I have paid',
    notPaidYet: 'Payment not received yet',
    paymentExpired: 'Payment has expired',
    recentActivity: 'Recent Activity',
    last30Days: 'Last 30 days',
    topUpOrder: 'Top-up Order',
    clickToShowOrderNo: 'Click to show order number',
