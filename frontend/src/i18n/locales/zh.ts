export default {
  ...
  auth: {
    ...
    referralCodeLabel: '推荐码（选填）',
    referralCodePlaceholder: '输入推荐人的推荐码',
  ...
  profile: {
    ...
    vip: {
      title: 'VIP 等级',
      enabledHint: '当前账户已启用 VIP 计费规则',
      disabledHint: '当前仅展示等级进度，未启用 VIP 折扣',
      currentLevel: '当前等级',
      multiplier: '当前倍率',
      progress: '升级进度',
      upgradeProgress: '距离下一等级',
      rechargeTotal: '累计实付',
      spendTotal: '累计消费',
      nextLevel: '下一等级',
      remainingRecharge: '还差实付',
      remainingSpend: '还差消费',
      maxLevelReached: '已达到最高 VIP 等级'
    },
    administrator: '管理员',
    user: '用户',
    username: '用户名',
  ...
  admin: {
    ...
    groups: {
      ...
      rateMultipliers: '已设置的用户倍率',
      addUserRate: '添加用户专属倍率',
      searchUserPlaceholder: '搜索用户邮箱...',
      noRateMultipliers: '暂无用户专属倍率设置',
      clearAll: '全部清空',
      batchAdjust: '批量调整',
    ...
    accounts: {
      ...
      fetchingUpstreamModels: '正在获取...',
      fetchUpstreamModelsSuccess: '成功添加 {count} 个模型',
      fetchUpstreamModelsFailed: '获取上游模型失败',
      upstreamModelsTotal: '共获取到 {count} 个模型，请选择要添加的厂商',
      selectModelProvider: '选择模型厂商',
      selectAll: '全选',
      deselectAll: '取消全选',
    ...
    paymentOrders: {
      title: '订单记录',
      description: '查看所有用户的支付订单',
      searchPlaceholder: '搜索订单号或用户ID',
      allStatus: '全部状态',
      pending: '待支付',
      paid: '已支付',
      expired: '已过期',
      ...
      statsTitle: '收入概览',
      todayRevenue: '今日收入',
      yesterdayRevenue: '昨日收入',
      weekRevenue: '本周收入',
      totalRevenue: '累计收入',
      orders: '笔',
      revenueTrend: '收入趋势',
      methodBreakdown: '支付方式分布',
      days7: '7天',
      days30: '30天',
      days90: '90天',
      vsYesterday: '较昨日',
    ...
    settings: {
      ...
      payment: {
        title: '支付设置',
        description: '配置支付网关和充值选项',
        enabled: '启用支付',
        enabledHint: '允许用户通过在线支付充值余额',
        generalTitle: '基本设置',
        currency: '货币',
        currencyHint: '支付使用的货币类型',
        exchangeRate: '汇率',
        exchangeRateHint: '支付货币到积分的兑换比例（如 1 元 = 1 积分）',
        presetAmounts: '预设金额',
        presetAmountsHint: '用逗号分隔的预设金额选项，供用户快速选择',
        minAmount: '最小金额',
        minAmountHint: '允许的最小支付金额',
        maxAmount: '最大金额',
        maxAmountHint: '允许的最大支付金额',
        alipayTitle: '支付宝',
        alipayMode: '支付宝模式',
        alipayModeDisabled: '关闭',
        alipayModeRegular: '网页支付',
        alipayModeF2f: '当面付 (扫码)',
        alipayAppId: '应用 ID',
        alipayAppIdHint: '支付宝应用 App ID',
        alipayPrivateKey: '私钥',
        alipayPrivateKeyHint: '已配置（留空保持不变）',
        alipayPrivateKeyPlaceholder: '输入支付宝私钥',
        alipayPublicKey: '公钥',
        alipayPublicKeyHint: '已配置（留空保持不变）',
        alipayPublicKeyPlaceholder: '输入支付宝公钥',
        wechatTitle: '微信支付',
        wechatEnabled: '启用微信支付',
        wechatAppId: '应用 ID',
        wechatAppIdHint: '微信支付 App ID',
        wechatMchId: '商户号',
        wechatMchIdHint: '微信支付商户号',
        wechatApiKey: 'API 密钥',
        wechatApiKeyHint: '已配置（留空保持不变）',
        wechatApiKeyPlaceholder: '输入微信支付 API 密钥',
        epayTitle: '易支付',
        epayEnabled: '启用易支付',
        epayType: '支付类型',
        epayTypeAlipay: '支付宝',
        epayTypeWechat: '微信',
        epayTypeBoth: '全部',
        epayTypeHint: '选择易支付启用的支付方式',
        epayApiUrl: 'API 地址',
        epayApiUrlHint: '易支付网关 API 地址',
        epayApiUrlPlaceholder: 'https://pay.example.com',
        epayPid: '商户 ID',
        epayPidHint: '易支付商户 PID',
        epayKey: '密钥',
  ...
  version: {
    ...
    dockerModeHint: 'Docker 部署请拉取最新 {image} 镜像后重建容器',
    updateNow: '立即更新',
    updating: '正在更新...',
    updateComplete: '更新完成',
    updateFailed: '更新失败',
  ...
  wallet: {
    ...
    customAmount: '自定义金额',
    enterAmount: '输入金额',
    amountRange: '范围: {min} - {max}',
    creditPreview: '将获得 {credit} 积分',
    paymentMethod: '支付方式',
    methodAlipay: '支付宝',
    methodAlipayF2f: '支付宝',
    methodWechat: '微信支付',
    ...
    scanQrCode: '扫描二维码完成支付',
    paymentSuccessTitle: '支付成功',
    paymentSuccessMessage: '您的余额已更新',
