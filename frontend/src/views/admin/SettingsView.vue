    ...
    <div class="mx-auto max-w-4xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6">
        ...
        <div v-show="activeTab === 'payment'" class="space-y-6">
          <!-- Payment Loading -->
          <div v-if="paymentLoading" class="flex items-center justify-center py-12">
            <div class="h-8 w-8 animate-spin rounded-full border-b-2 border-primary-600"></div>
          </div>
          <template v-else>
            <!-- Enable Payment -->
            <div class="card">
              ...
              <div class="space-y-5 p-6">
                <div class="flex items-center justify-between">
                  ...
                  <Toggle v-model="paymentForm.payment_enabled" />
                </div>
              </div>
            </div>

            <!-- Payment Config - Only show when enabled -->
            <template v-if="paymentForm.payment_enabled">
              <!-- General Settings -->
              <div class="card">
                <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
                  <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                ...
                <div class="space-y-5 p-6">
                  <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                      ...
                      <select v-model="paymentForm.payment_currency" class="input">
                    ...
                    <div>
                      ...
                      <input v-model.number="paymentForm.payment_exchange_rate" type="number" step="0.0001" min="0" class="input" placeholder="1.0" />
                  ...
                  <div>
                    ...
                    <input v-model="paymentForm.payment_preset_amounts" type="text" class="input" placeholder="10,20,50,100" />
                  ...
                  <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                      ...
                      <input v-model.number="paymentForm.payment_min_amount" type="number" step="0.01" min="0" class="input" placeholder="1" />
                    ...
                    <div>
                      ...
                      <input v-model.number="paymentForm.payment_max_amount" type="number" step="0.01" min="0" class="input" placeholder="10000" />
                ...
                <div class="space-y-4 p-6">
                  ...
                  <div v-if="alipayMode !== 'disabled'" class="space-y-4">
                    <div>
                      ...
                      <input v-model="paymentForm.payment_alipay_app_id" type="text" class="input font-mono text-sm" />
                    ...
                    <div>
                      ...
                      <input v-model="paymentForm.payment_alipay_private_key" type="password" class="input font-mono text-sm" :placeholder="paymentForm.payment_alipay_private_key_configured ? t('admin.settings.payment.alipayPrivateKeyHint') : t('admin.settings.payment.alipayPrivateKeyPlaceholder')" />
                    </div>
                    <div>
                      ...
                      <input v-model="paymentForm.payment_alipay_public_key" type="password" class="input font-mono text-sm" :placeholder="paymentForm.payment_alipay_public_key_configured ? t('admin.settings.payment.alipayPublicKeyHint') : t('admin.settings.payment.alipayPublicKeyPlaceholder')" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                ...
                <div class="space-y-4 p-6">
                  <div class="flex items-center justify-between">
                    ...
                    <Toggle v-model="paymentForm.payment_wechat_enabled" />
                  </div>
                  <div v-if="paymentForm.payment_wechat_enabled" class="space-y-4">
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('admin.settings.payment.wechatAppId') }}</label>
                      <input v-model="paymentForm.payment_wechat_app_id" type="text" class="input font-mono text-sm" />
                    ...
                    <div>
                      ...
                      <input v-model="paymentForm.payment_wechat_mch_id" type="text" class="input font-mono text-sm" />
                    ...
                    <div>
                      ...
                      <input v-model="paymentForm.payment_wechat_api_key" type="password" class="input font-mono text-sm" :placeholder="paymentForm.payment_wechat_api_key_configured ? t('admin.settings.payment.wechatApiKeyHint') : t('admin.settings.payment.wechatApiKeyPlaceholder')" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                ...
                <div class="space-y-4 p-6">
                  <div class="flex items-center justify-between">
                    ...
                    <Toggle v-model="paymentForm.payment_epay_enabled" />
                  </div>
                  <div v-if="paymentForm.payment_epay_enabled" class="space-y-4">
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('admin.settings.payment.epayType') }}</label>
                      <select v-model="paymentForm.payment_epay_type" class="input">
                    ...
                    <div>
                      ...
                      <input v-model="paymentForm.payment_epay_api_url" type="url" class="input font-mono text-sm" :placeholder="t('admin.settings.payment.epayApiUrlPlaceholder')" />
                    ...
                    <div>
                      ...
                      <input v-model="paymentForm.payment_epay_pid" type="text" class="input font-mono text-sm" />
                    ...
                    <div>
                      ...
                      <input v-model="paymentForm.payment_epay_key" type="password" class="input font-mono text-sm" :placeholder="paymentForm.payment_epay_key_configured ? t('admin.settings.payment.epayKeyHint') : t('admin.settings.payment.epayKeyPlaceholder')" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card">
              ...
              <div class="space-y-5 p-6">
                <div class="flex items-center justify-between">
                  ...
                  <Toggle v-model="paymentForm.referral_enabled" />
                </div>
                <div v-if="paymentForm.referral_enabled">
                  <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('referral.commissionRateLabel') }} (%)</label>
                  <input
                    v-model.number="paymentForm.referral_commission_rate"
                    type="number"
                    step="0.1"
                    min="0"
                    max="100"
            ...
            <div class="flex justify-end">
              <button type="button" @click="savePaymentSettings" :disabled="paymentSaving" class="btn btn-primary px-8 py-2.5">
                <svg
                  v-if="paymentSaving"
        ...
        <!-- Save Button (hidden on payment tab which has its own save) -->
        <div v-show="activeTab !== 'payment'" class="flex justify-end">
...
type SettingsTab = 'general' | 'security' | 'users' | 'gateway' | 'email' | 'payment'
...
// Payment settings 状态 (uses separate API)
...
const alipayMode = computed({
  get() {
    if (paymentForm.payment_alipay_f2f_enabled) return 'f2f'
    if (paymentForm.payment_alipay_enabled) return 'regular'
    return 'disabled'
  },
  set(val: string) {
    paymentForm.payment_alipay_enabled = val === 'regular'
    paymentForm.payment_alipay_f2f_enabled = val === 'f2f'
  }
})
...
async function loadPaymentSettings() {
  ...
  try {
    ...
    paymentForm.payment_enabled = settings.payment_enabled ?? false
    paymentForm.payment_currency = settings.payment_currency ?? 'CNY'
    paymentForm.payment_exchange_rate = settings.payment_exchange_rate ?? 1
    paymentForm.payment_preset_amounts = settings.payment_preset_amounts ?? '10,20,50,100'
    paymentForm.payment_min_amount = settings.payment_min_amount ?? 1
    paymentForm.payment_max_amount = settings.payment_max_amount ?? 10000
    paymentForm.payment_alipay_enabled = settings.payment_alipay_enabled ?? false
    paymentForm.payment_alipay_app_id = settings.payment_alipay_app_id ?? ''
    paymentForm.payment_alipay_private_key_configured = settings.payment_alipay_private_key_configured ?? false
    paymentForm.payment_alipay_public_key_configured = settings.payment_alipay_public_key_configured ?? false
    paymentForm.payment_alipay_f2f_enabled = settings.payment_alipay_f2f_enabled ?? false
    paymentForm.payment_wechat_enabled = settings.payment_wechat_enabled ?? false
    paymentForm.payment_wechat_app_id = settings.payment_wechat_app_id ?? ''
    paymentForm.payment_wechat_mch_id = settings.payment_wechat_mch_id ?? ''
    paymentForm.payment_wechat_api_key_configured = settings.payment_wechat_api_key_configured ?? false
    paymentForm.payment_epay_enabled = settings.payment_epay_enabled ?? false
    paymentForm.payment_epay_type = settings.payment_epay_type ?? 'alipay'
    paymentForm.payment_epay_api_url = settings.payment_epay_api_url ?? ''
    paymentForm.payment_epay_pid = settings.payment_epay_pid ?? ''
    paymentForm.payment_epay_key_configured = settings.payment_epay_key_configured ?? false
    paymentForm.referral_enabled = settings.referral_enabled ?? false
    paymentForm.referral_commission_rate = (settings.referral_commission_rate ?? 0) * 100
    paymentForm.payment_alipay_private_key = ''
    paymentForm.payment_alipay_public_key = ''
    paymentForm.payment_wechat_api_key = ''
    paymentForm.payment_epay_key = ''
  } catch (error: any) {
    appStore.showError(
      t('admin.settings.failedToLoad') + ': ' + (error.message || t('common.unknownError'))
    )
...
async function savePaymentSettings() {
  ...
  try {
    const payload: UpdatePaymentSettingsRequest = {
      payment_enabled: paymentForm.payment_enabled,
      payment_currency: paymentForm.payment_currency,
      payment_exchange_rate: paymentForm.payment_exchange_rate,
      payment_preset_amounts: paymentForm.payment_preset_amounts,
      payment_min_amount: paymentForm.payment_min_amount,
      payment_max_amount: paymentForm.payment_max_amount,
      payment_alipay_enabled: paymentForm.payment_alipay_enabled,
      payment_alipay_app_id: paymentForm.payment_alipay_app_id,
      payment_alipay_private_key: paymentForm.payment_alipay_private_key || undefined,
      payment_alipay_public_key: paymentForm.payment_alipay_public_key || undefined,
      payment_alipay_f2f_enabled: paymentForm.payment_alipay_f2f_enabled,
      payment_wechat_enabled: paymentForm.payment_wechat_enabled,
      payment_wechat_app_id: paymentForm.payment_wechat_app_id,
      payment_wechat_mch_id: paymentForm.payment_wechat_mch_id,
      payment_wechat_api_key: paymentForm.payment_wechat_api_key || undefined,
      payment_epay_enabled: paymentForm.payment_epay_enabled,
      payment_epay_type: paymentForm.payment_epay_type,
      payment_epay_api_url: paymentForm.payment_epay_api_url,
      payment_epay_pid: paymentForm.payment_epay_pid,
      payment_epay_key: paymentForm.payment_epay_key || undefined,
      referral_enabled: paymentForm.referral_enabled,
      referral_commission_rate: paymentForm.referral_commission_rate / 100
    }
    const updated = await adminAPI.settings.updatePaymentSettings(payload)
    paymentForm.payment_alipay_private_key_configured = updated.payment_alipay_private_key_configured ?? paymentForm.payment_alipay_private_key_configured
    paymentForm.payment_alipay_public_key_configured = updated.payment_alipay_public_key_configured ?? paymentForm.payment_alipay_public_key_configured
    paymentForm.payment_wechat_api_key_configured = updated.payment_wechat_api_key_configured ?? paymentForm.payment_wechat_api_key_configured
    paymentForm.payment_epay_key_configured = updated.payment_epay_key_configured ?? paymentForm.payment_epay_key_configured
    paymentForm.payment_alipay_private_key = ''
    paymentForm.payment_alipay_public_key = ''
    paymentForm.payment_wechat_api_key = ''
    paymentForm.payment_epay_key = ''
